...
{
    public partial class ApplicationAbout : Form
    {
        private readonly ModulesToShow _modulesToShow;
        private readonly string[] _excludes;

        private ApplicationAbout() {}

        public ApplicationAbout(ModulesToShow modulesToShow, string[] excludes)
        {
            InitializeComponent();
        ...
        {
            new ApplicationAbout(modulesToShow, excludes).ShowDialog();
        }
        ...
        private void LabelSolutionModulesClick(object sender, EventArgs e)
        {
            ...
            new SolutionModulesInfo().Init(appPath, _modulesToShow, _excludes);
        }
