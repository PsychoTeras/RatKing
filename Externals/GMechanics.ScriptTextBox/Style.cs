...
namespace GMechanics.ScriptTextBox
{
    ...
    public abstract class Style : IDisposable
    {
        ...
        /// Occurs when user click on StyleVisualMarker joined to this style 
        /// </summary>
        public virtual void OnVisualMarkerClick(ScriptTextBoxControl tb, VisualMarkerEventArgs args)
        {
        ...
        /// </summary>
        protected virtual void AddVisualMarker(ScriptTextBoxControl tb, StyleVisualMarker marker)
        {
    ...
    public class TextStyle : Style
    {
        ...
        public override void Draw(Graphics gr, Point position, Range range)
        {
            ...
            {
                SizeF size = ScriptTextBoxControl.GetCharSize(f, line[i].c);
