...
namespace GMechanics.ScriptTextBox
{
    ...
    public class Range : IEnumerable<Place>
    {
        Place start;
        Place end;
        public readonly ScriptTextBoxControl tb;
        int preferedPos = -1;
        int updating = 0;
        ...
        /// Constructor
        /// </summary>
        public Range(ScriptTextBoxControl tb)
        {
            this.tb = tb;
        }
        ...
        /// Constructor
        /// </summary>
        public Range(ScriptTextBoxControl tb, int iStartChar, int iStartLine, int iEndChar, int iEndLine)
            : this(tb)
        {
        ...
        /// Constructor
        /// </summary>
        public Range(ScriptTextBoxControl tb, Place start, Place end)
            : this(tb)
        {
            this.start = start;
            this.end = end;
